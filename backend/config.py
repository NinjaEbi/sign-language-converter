...
# MODEL
# ─────────────────────────────────────────────
MODEL_PATH         = os.getenv("MODEL_PATH", "../model/saved/best_model.h5")
LABEL_MAP_PATH     = os.getenv("LABEL_MAP_PATH", "../dataset/final/label_map.json")
...
# STORAGE
# ─────────────────────────────────────────────
NEW_DATA_DIR      = os.getenv("NEW_DATA_DIR", "../new_data")